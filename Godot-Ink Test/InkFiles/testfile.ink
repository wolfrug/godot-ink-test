...
* [Start included game]
Edit.
->testFile_included_Start


=== murder_scene ===
    The bedroom. This is where it happened. Now to look for clues. PORTRAIT(1) BACKGROUND(0) PLAY_MUSIC(0) #test
- (top)
    { bedroomLightState ? seen:     <- seen_light  }
    <- compare_prints(-> top)

    *   (dobed) [The bed...]
        The bed was low to the ground, but not so low something might not roll underneath. It was still neatly made. PORTRAIT(0) BACKGROUND(1)
        ~ reach (neatly_made)
        - - (bedhub)
        * *     [Lift the bedcover]
